...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Heartbeat" },
      { name: "description", content: "A calm command center for your accounts — calendars, tasks, notes and meetings in one place." },
      { name: "theme-color", content: "#F5F0E8" },
      { property: "og:title", content: "Heartbeat" },
      { name: "twitter:title", content: "Heartbeat" },
      { property: "og:description", content: "A calm command center for your accounts — calendars, tasks, notes and meetings in one place." },
      { name: "twitter:description", content: "A calm command center for your accounts — calendars, tasks, notes and meetings in one place." },
